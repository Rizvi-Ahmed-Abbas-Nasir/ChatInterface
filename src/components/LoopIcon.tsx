...
export const LogoLoop = React.memo<LogoLoopProps>(
  ...
  <span
    className={cx(
      'inline-flex items-center text-gray-800', // force darker icon/text
  ...
  <img
    className={cx(
      'h-[var(--logoloop-logoHeight)] w-auto block object-contain filter brightness-0', // make img darker
